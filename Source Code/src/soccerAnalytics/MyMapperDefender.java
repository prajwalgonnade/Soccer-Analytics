...
public class MyMapperDefender extends Mapper<LongWritable, Text, Text, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		try {
			...
			// Define the attribute columns for Defender
			int[] attributeNumber = { 6, 7, 8, 9, 10, 11 };
			...
			// Filter input data for Defender
