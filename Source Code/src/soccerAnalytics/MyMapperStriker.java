...
public class MyMapperStriker extends Mapper<LongWritable, Text, Text, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		try {
			...
			// Define the attribute columns for Striker
			int[] attributeNumber = { 4, 5, 6, 7, 11, 13, 16, 17 };
