...
public class MyMapperMidfielder extends Mapper<LongWritable, Text, Text, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		try {
			...
			// Define the attribute columns for Midfielder
			int[] attributeNumber = { 4, 5, 6, 7, 8, 10, 11, 13, 15, 16, 17 };
			...
			// Filter input data for Midfielder
